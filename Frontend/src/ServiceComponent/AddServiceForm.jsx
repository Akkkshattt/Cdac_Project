...
const AddServiceForm = () => {
  ...
  const validateForm = () => {
    ...
    if (service.category === "PC Builder" && !service.subCategoryId) {
      isValid = false;
      formErrors["subCategoryId"] = "Subcategory is required for PC Builder.";
    }
          ...
          <div className="container-fluid">
            ...
            >
              <h5 className="card-title">
                Enter details about your services here
              </h5>
            </div>
