...
import com.pcbuilder.service.ServiceResource;
...
public class ServiceController {
	...
	public ResponseEntity<ServiceResponse> fetchAllServicesByTechExpert(@RequestParam("techExpertId") Integer techExpertId) {
	...
	public ResponseEntity<ServiceResponse> fetchAllServicesByCategory(@RequestParam("category") String category) {
		return serviceResource.fetchAllServicesByCategory(category);
	}
	...
	@GetMapping("request/requirement/{requirment_FileName}/download")
	...
	public ResponseEntity<Resource> downloadPlan(
			@PathVariable("requirmentFileName") String FileName,
			HttpServletResponse response) throws DocumentException, IOException {
		return this.serviceResource.downloadRequirment( FileName, response);
	}
